<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="Login"  EnableEventValidation="false" ViewStateEncryptionMode="Never" %>
...
<asp:Login ID="Login1" runat="server"   TitleTextStyle-Font-Bold="true" 
    ...
    Height="155px" Width="312px" DestinationPageUrl="/" >
