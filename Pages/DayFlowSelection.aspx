<%@ Page Title="מהלך היום - רגעים מנצחים, צילום אירועים" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DayFlowSelection.aspx.cs" Inherits="DayFlowSelection" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <div style="background-image:url('/Images/DayFlow/Title.jpg');width:900px;height:30px;margin-top:25px; margin-bottom:70px" ></div>
