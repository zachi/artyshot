  ...
  $.widget("ui.dialog", {
    ...
    _create: function () {
      ...
      var self = this,
        ...
        uiDialog = (self.uiDialog = $("<div>")).appendTo(document.body).hide().addClass(uiDialogClasses + options.dialogClass)
          .css({ zIndex: options.zIndex })     // setting tabIndex makes the div focusable
          .attr("tabIndex", -1)
